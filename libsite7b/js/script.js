...
*/
    ...
    * Copyright (c) 2016 Dmitry Semenov; */
    ...
    jQuery('.showcase-gallery > div > a').magnificPopup({
      type:'image', 
      gallery: {
        // options for gallery
        enabled: true
	  ...
	  return item.el.parent().find(".showcase-caption").clone();
        }
      }
    });
/*
    jQuery(".showcase-gallery > div > a").colorbox({rel: "gal", width:"90%", height:"90%", title: function() {
      var caption = jQuery(this).parent().find(".showcase-caption");
console.log(caption);
      return caption;
    }});
*/
    ...
    jQuery(".showcase-gallery").hoverIntent(function() {
