	            ...
	            <li class='leaf'><a href='" . $front_page . "reference/directory' onClick=\"ga('send','event','primary-nav','/primary-nav/gelman/research-staff');\">Research Staff</a></li>
					...
					<li class='first-prim expanded nav-item' id=\"nav-eckles-research\">
					  ...
					  <ul class='sub-menu-group'>
							...
							<li class='leaf'><a href='http://libguides.gwu.edu/'>Topics: </a><span class='leaf-extended'><a href='http://libguides.gwu.edu/content.php?pid=12069'>Industry</a> | <a href='https://libguides.gwu.edu/data-management'>Data Management</a> | <a href='http://libguides.gwu.edu/'>More...</a></span></li>
