...
/* TOP HAT NECESSITIES BEGIN */
	...
	if($('#heroImage p.1').html()!==null && $.trim($('#heroImage p.1').html()) == "") {
    	$('#heroCaption').hide();
    }
...
/* TOP HAT NECESSITIES END */	
	...
	$('#footerRight li a').filter(function(){
				return this.hostname &&                             // check to see if it's a link
					   ...
					   this.hostname.indexOf('.gwumc.edu') === -1 &&  // check to see if it's a ***.gwu.edu link
					   ...
					   this.hostname.indexOf('atthecenterofitall') === 0;  //check for business rss url
